...
import { BaseHSAPI, BaseHSLobby, BaseHSProfile, BaseJoinToCreate, BaseReactionRole, BaseRSConfig, BaseTrackList } from "@utils/classes"
...
export const defaultData = {
    ...
    hsProfile: [] as BaseHSProfile[],
    hsLobby: [] as BaseHSLobby[]
}
